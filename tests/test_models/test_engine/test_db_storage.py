...
class TestDBStorage(unittest.TestCase):
    ...
    def test_dbstorage_user_attr(self):
        ...
        '''
        new = User(email="jerryseazia@gmail.com", password="hello")
        self.assertTrue(new.email, "jerryseazia@gmail.com")
    ...
    def test_dbstorage_all(self):
        ...
        new = User(email="jerry@alx.com", password="abc")
        console = self.create()
    ...
    def test_dbstorage_delete(self):
        ...
        '''
        new_user = User(email="yourmail@alx.com", password="abc",
                        first_name="Jerry", last_name="Seazia")
